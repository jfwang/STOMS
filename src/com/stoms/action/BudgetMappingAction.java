...
public class BudgetMappingAction extends ActionSupport{
	...
	public String saveMapping() {
		if(projectId.equals("null")) {
			...
			budgetMappingService.saveMapping(projectId, manager, research, srbusiness, test, energy, 
				meetings, publishments, otherSrbusiness, experimentMaterial, rawMaterial, otherMaterial, 
